/*************************************************************************
    ...
    > Created Time: 2023年01月12日 星期四 13时57分30秒
 ************************************************************************/
#ifndef HTTPCONNETCTION_H
#define HTTPCONNETCTION_H
...
class http_conn{
	...
	private:
		...
		int m_read_idx;  // 标示读缓冲区中以及读入的客户端的最后一个字节的下一个位置
		...
		HTTP_CODE process_read();  // 解析HTTP 请求
